...
const couchGetOpts = (query) => {
    cy.task('consoleLogger', `\n\n\n###### CoucDb utils.js --> couchGetOpts() ::
      query :: ${query}
      url :: ${Cypress.env('CH_URL')}\n`);
  return {
...
const latinise = str => str.replace(/[^A-Za-z0-9\[\] ]/g, a => Latinise.latin_map[a] || a); // eslint-disable-line no-useless-escape

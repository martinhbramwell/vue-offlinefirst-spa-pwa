...
<soap:Body>
    ...
    <RespuestaRecepcionComprobante>
        ...
        <comprobantes>
            <comprobante>
                <claveAcceso>0509201901179217775800110010020000003381234567817</claveAcceso>
                <mensajes>
                    <mensaje>
...
`;
        ...
        CLG('XML parse result');
        CLG('\nxmlProcesamiento :: ');
        CDR(decodeSriUploadXml(xmlProcesamiento));
        CLG('\nxmlDevuelta :: ');
        CDR(decodeSriUploadXml(xmlDevuelta));
        CLG('\nxmlRecibida :: ');
        CDR(decodeSriUploadXml(xmlRecibida));
        break;
      default:
    }

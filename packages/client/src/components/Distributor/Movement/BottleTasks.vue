      ...
      <div class="card" >
        <header class="card-header">
          ...
          <div class="card-header-icon" aria-label="more options">
            <button id="control-button" :class="PersonsButton.class"
                    @click="openShutPersons('toggle')" ref="personsButton">
              <span class="is-size-7">{{ PersonsButton.text }}</span>
            </button>
            <button id="control-button" :class="CameraButton.class"
                    @click="openShutCamera('toggle')" ref="CameraButton">
        ...
        <div class="card-content">
          ...
          <nav class="level">
            ...
            <div class="level-left">
              ...
              <div class="level-item">
                <autocomplete-input
                  :elemId="'person-picker'"
                  :items="personPicker || null"
                  ref="prsnPckr"
                />
                ...
                <template slot-scope="props">
                  <tr v-if="props.item.type === 'chosen'" class="chosen" :key="props.itemKey">
                    <td @click="picked(props)" class="tag is-info persons">
                      ...
                      <span class="italic"> &nbsp; {{props.item.data.email}}</span>
                    </td>
                  </tr>
          ...
          <div class="column is-one-quarter" id="drag-column">
            ...
            <nav class="level">
              <div class="level-item has-text-centered control is-small">
                <input class="input is-small" :disabled="!autocompleteDirty"
                type="text" placeholder="Codigo" v-model="newInventoryBottle"
                id="inp-esp-envase" @keyup.13="addNewBottle('Inventory')"
                @focus="closeError(UNKNOWN_BOTTLE_ERROR)">
              </div>
              <p class="level-item has-text-centered control is-small">
                <a class="button is-small" :disabled="!autocompleteDirty"
                @click="addNewBottle('Inventory')" id="butt-add-inventory-bottle">
...
<!--
 ...
 -->
            <div class="container scrollable-container">
              <Container :group-name="'1'" :get-child-payload="inventoryPayload"
                         :should-accept-drop="shouldAcceptInventory"
                         @drop="onDrop('inventory', $event)">
          ...
          <div class="column is-one-quarter" id="drag-column">
            ...
            <div class="trashBin">
              <nav class="level">
                <div class="level-item has-text-centered">
                  <Container :group-name="'1'" :should-accept-drop="shouldTrash"
                             @drop="onDrop('trash', $event)">
            ...
            <div class="container scrollable-container">
              <Container :group-name="'1'" :get-child-payload="exchangePayload"
                         :should-accept-drop="shouldAcceptExchange"
                         @drop="onDrop('exchange', $event)">
            ...
            <nav class="level">
              <div class="level-item has-text-centered control is-small is-primary">
                <a class="button is-small is-warning" :disabled="!autocompleteDirty"
                   @click="saveMovements" id="butt-save-moves">
          ...
          <div class="column is-one-quarter" id="drag-column">
            ...
            <nav class="level">
              <div class="level-item has-text-centered control is-small">
                <input class="input is-small" :disabled="!autocompleteDirty"
                        type="text" placeholder="Codigo" v-model="newCustomerBottle"
                        id="inp-esp-envase" @keyup.13="addNewBottle('Customer')"
                        @focus="closeError(UNKNOWN_BOTTLE_ERROR)">
              </div>
              <p class="level-item has-text-centered control is-small">
                <a class="button is-small" :disabled="!autocompleteDirty"
                   @click="addNewBottle('Customer')" id="butt-add-customer-bottle">
                  <span class="is-size-7"><strong>Especificar Envase</strong></span>
                </a>
              </p>
            </nav>
...
<!--
 ...
 -->
            <div class="container scrollable-container">
              <Container :group-name="'1'" :get-child-payload="customerPayload"
                         :should-accept-drop="shouldAcceptCustomer"
                         @drop="onDrop('customer', $event)">
...
const vm = {
  ...
  data() {
    return {
      ...
      fruits: [
        { codigo: 101, nombre: 'Apple' },
        { codigo: 102, nombre: 'Banana' },
        { codigo: 103, nombre: 'Orange' },
        { codigo: 104, nombre: 'Mango' },
        { codigo: 105, nombre: 'Pear' },
        { codigo: 106, nombre: 'Peach' },
        { codigo: 107, nombre: 'Grape' },
